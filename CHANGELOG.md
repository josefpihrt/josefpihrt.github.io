...
- Update Roslynator to `4.14.1` ( [PR](https://github.com/josefpihrt/josefpihrt.github.io/pull/63))
- Update Roslynator CLI to `0.11.0` ([PR](https://github.com/josefpihrt/josefpihrt.github.io/pull/63))
...
- Update Roslynator to `4.13.0` ( [PR](https://github.com/josefpihrt/josefpihrt.github.io/pull/60))
- Update Roslynator CLI to `0.10.1` ([PR](https://github.com/josefpihrt/josefpihrt.github.io/pull/60))

## [0.4.27] - 2025-01-29

### Added

- Update Roslynator to `4.12.11` ( [PR](https://github.com/josefpihrt/josefpihrt.github.io/pull/59))
- Update Roslynator CLI to `0.10.0` ([PR](https://github.com/josefpihrt/josefpihrt.github.io/pull/59))
...
- Autogenerate the page with Roslynator CLI commands ([PR](https://github.com/josefpihrt/josefpihrt.github.io/pull/50))
